    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black items-center justify-center">
        <div className="px-12 max-w-lg text-center">
          ...
          <h1 className="text-4xl font-bold text-white mb-6">Dantsri</h1>
          <p className="text-gray-300 text-lg leading-relaxed mb-8">
            Welcome to the Dantsri administration portal. Manage appointments, patient records, and clinic operations with ease.
          </p>
          ...
          <div className="mt-10">
            ...
            <div className="mt-6 text-center">
              <span className="text-sm text-gray-500">
                ...
                <a href="mailto:support@dantsri.com" className="font-medium text-gray-700 hover:text-black transition-colors duration-200 border-b border-transparent hover:border-black">
                  support@dantsri.com
                </a>
              </span>
            </div>
